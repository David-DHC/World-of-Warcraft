...
2.  Do all related quests throughout Hellfire Peninsula can give around 12000 reputation.
...
1.  Finish the quest chain starting from **Kindness** in Netherwing Fields, Shadowmoon Valley to unlock this faction. After you finish the quest chain, you will instantly reach Neutral from Hatred.
2.  Farm all dailies and quests in Netherwing Fields, as well as The Aldor or The Scryers base.
...
1.  Finish all quests in Ogri'la, including the quests in Sha'tar Skyguard camp north of Ogri'la.

2.  There are four dailies which increase Ogri'la reputation:
    -   Banish More Demons (requires Honored)
    -   Wrangle More Aether Rays (requires Friendly) (also increases Sha'tar Skyguard reputation)
    -   The Relics Emanation
    -   Bomb them Again! (also increases Sha'tar Skyguard reputation)
...
2.  Farming the mobs before Rage Winterchill gives around 1000 reputation, up to exalted. The steps are:
    ...
    It is said that Druid's Dreamwalk or DK's Death Gate may work the same.
...
6.  Quests scattered all around the Outland may give some thousand of reputation.
...
3.  Upon reaching exalted, you need to complete the **A Magnanimous Benefactor** quest in the Isle of Quel'Danas, which costs you 1000 gold to earn the title **of the Shattered Sun**.
...
2.  Turn in the following items to gain reputation. They can all be bought from AH though.
    ...
    Note that Firewing Signet can be farmed at **Firewing Point** in Terokkar Forest, and the others can be farmed from all Sunfury Blood Elves, where you can find many around **Ruins of Karabor** in Shadowmoon Valley.

    Signets should be turned in to **Magitrix Fyalenn**, while Arcane Tome to **Voren'thal the Seer**, both on Scryer's Tier.

3.  Find **Arcanist Adyria** for the quests to switch between The Aldor and The Scryers.
